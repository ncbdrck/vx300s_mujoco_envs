...
register(
    id='VX300SMujocoRobotGoalEnv-v0',
    entry_point='vx300s_mujoco_envs.robot_envs.vx300s_mujoco_robot_goal:VX300SMujocoRobotGoalEnv',
    max_episode_steps=1000,
)


class VX300SMujocoRobotGoalEnv(MujocoGoalEnv.MujocoGoalEnv):
    """
