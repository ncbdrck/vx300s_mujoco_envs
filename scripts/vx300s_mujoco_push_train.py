#!/usr/bin/env python3
"""
Train an SB3 SAC policy on the VX300S MuJoCo push task.

Standard env id: ``VX300SMujocoPushSim-v0``
...
The SAC hyper-parameters live in this package's config/vx300s_pusher_sac.yaml.
...
CONFIG_FILE = "vx300s_pusher_sac.yaml"

# Paths are relative to this package (model_pkg_path below).
PKG = "vx300s_mujoco_envs"
SAVE_PATH = "/models/sim/sac/vx300s/push/"
LOG_PATH = "/logs/sim/sac/vx300s/push/"
