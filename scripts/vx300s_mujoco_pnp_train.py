#!/usr/bin/env python3
"""
Train an SB3 SAC policy on the VX300S MuJoCo pick-and-place task.

Standard env id: ``VX300SMujocoPnpSim-v0``

Default (self-launch): one command brings up roscore + the MuJoCo server + controllers and trains:
    rosrun vx300s_mujoco_envs vx300s_mujoco_pnp_train.py
Pass --attach to instead connect to a stack started with the package launch file.
The SAC hyper-parameters live in this package's config/vx300s_pnp_sac.yaml.
...
# SAC hyper-parameters live in this package's config/.
CONFIG_PKG = "vx300s_mujoco_envs"
CONFIG_FILE = "vx300s_pnp_sac.yaml"

# Paths are relative to this package (model_pkg_path below).
PKG = "vx300s_mujoco_envs"
SAVE_PATH = "/models/sim/sac/vx300s/pnp/"
LOG_PATH = "/logs/sim/sac/vx300s/pnp/"
