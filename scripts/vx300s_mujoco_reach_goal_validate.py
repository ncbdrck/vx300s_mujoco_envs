#!/usr/bin/env python3
"""
Validate a trained SAC+HER policy on the goal-conditioned VX300S MuJoCo reach task.
...
MODEL_BASE = "/models/sim/sac/vx300s/reach_goal/"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--model-tag", default="trained_model_reach_goal",
