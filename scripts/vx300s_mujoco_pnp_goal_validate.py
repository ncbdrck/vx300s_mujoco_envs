#!/usr/bin/env python3
"""
Validate a trained SAC+HER policy on the goal-conditioned VX300S MuJoCo pick-and-place task.
...
Default (self-launch): one command brings up the sim + controllers and validates:
    rosrun vx300s_mujoco_envs vx300s_mujoco_pnp_goal_validate.py
...
MODEL_BASE = "/models/sim/sac/vx300s/pnp_goal/"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--model-tag", default="trained_model_pnp_goal",
