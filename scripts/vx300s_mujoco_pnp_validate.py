#!/usr/bin/env python3
"""
Validate a trained SAC policy on the VX300S MuJoCo pick-and-place task.
...
Default (self-launch): one command brings up the sim + controllers and validates:
    rosrun vx300s_mujoco_envs vx300s_mujoco_pnp_validate.py
...
MODEL_BASE = "/models/sim/sac/vx300s/pnp/"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--model-tag", default="trained_model_pnp",
