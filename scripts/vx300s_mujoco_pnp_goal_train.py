#!/usr/bin/env python3
"""
Train an SB3 SAC+HER policy on the goal-conditioned VX300S MuJoCo pick-and-place task.

Standard env id: ``VX300SMujocoPnpGoalSim-v0``

Default (self-launch): one command brings up roscore + the MuJoCo server + controllers and trains:
    rosrun vx300s_mujoco_envs vx300s_mujoco_pnp_goal_train.py
...
package's config/vx300s_pnp_goal_sac.yaml. Models and logs are written under this package.
"""
...
from vx300s_mujoco_envs.task_envs.pnp import vx300s_mujoco_pnp_goal  # noqa: F401
...
ENV_ID = "VX300SMujocoPnpGoalSim-v0"

CONFIG_PKG = "vx300s_mujoco_envs"
CONFIG_FILE = "vx300s_pnp_goal_sac.yaml"

PKG = "vx300s_mujoco_envs"
SAVE_PATH = "/models/sim/sac/vx300s/pnp_goal/"
LOG_PATH = "/logs/sim/sac/vx300s/pnp_goal/"
