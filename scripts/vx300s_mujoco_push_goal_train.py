#!/usr/bin/env python3
"""
Train an SB3 SAC+HER policy on the goal-conditioned VX300S MuJoCo push task.
...
package's config/vx300s_pusher_goal_sac.yaml. Models and logs are written under this package.
"""
...
SAVE_PATH = "/models/sim/sac/vx300s/push_goal/"
LOG_PATH = "/logs/sim/sac/vx300s/push_goal/"
