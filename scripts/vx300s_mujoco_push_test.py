...
the smoke test:
    rosrun vx300s_mujoco_envs vx300s_mujoco_push_test.py
...
# Environment registration (importing the module registers "VX300SMujocoPushSim-v0").
...
# so a single command runs everything. Set ATTACH_MODE = True to instead attach to a stack already
